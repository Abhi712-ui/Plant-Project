...
- Success metric: Classification accuracy of at least 85 percent on a test set, displayed through a deployed web interface where a user can upload an image and receive a prediction.
